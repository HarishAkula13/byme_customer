    ...
    builder: (context) => SingleChildScrollView(
      child: Container(
        ...
        child: StreamBuilder<List<Subcategory>>(
          initialData: [],
          stream: bloc.subcategoryList,
          builder: (context, s) {


            return (s.data!.length>0)?Padding(
                  ...
                  StreamBuilder<String>(
                    ...
                    builder: (context, sna) {
                      return Container(
                          ...
                          child: CustomDropdown(hint: 'Select', value: sna.data, dropdownItems: [sna.data!], onChanged:(val){ bloc.addSelectedName.add(val!);}));
                    }
                  ),
                  StreamBuilder<String>(
                      initialData: null,
                      ...
                      builder: (context, sna) {
                        ...
                        return Container(
                            ...
                            width: MediaQuery.of(context).size.width,
                            child: (list.length>0)?CustomDropdown(hint: 'Select', value: sna.data,
                                dropdownWidth: 300,
                                dropdownItems: list, onChanged:(val){ bloc.addSubCate.add(val!);}):SizedBox());
                      }
                  ),
                  StreamBuilder<String>(
